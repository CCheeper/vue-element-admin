<template>
  <div class="app-container">
    ...
    <el-table :key="tableKey" v-loading="listLoading" :data="list" border fit highlight-current-row style="width: 100%;" @sort-change="sortChange">
      ...
      <el-table-column label="学校名字" width="160px" align="center">
        <template slot-scope="scope">
...
<script>
import { fetchList, fetchPv, fetchTalentintrduction, createTalentintrduction } from '@/api/talenIntrduction'
...
export default {
  ...
  methods: {
    ...
    handleModifyStatus(row, status) {
      ...
      axios.post('/talenIntrduction/delete', {
        id: row.id
      })
    ...
    handleCreate() {
      ...
      var this_ = this
        ...
        axios
        .get("/talenIntrduction/getthings")
        .then(function(response) {
    ...
    createData(temp) {
      this.$refs['dataForm'].validate((valid) => {
        if (valid) {
          createTalentintrduction(this.temp).then(() => {
